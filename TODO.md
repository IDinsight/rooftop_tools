...
# Add demo notebook NO!!! JUST INSERT SAMPLE CODE INTO THE README
1. The notebook should start from a list of downloaded PSUs (barangays, )

# Update the README
1. In the getting started instructions, provide details on how to install from github or pypy
2. Provide sample code below each step in the process 
